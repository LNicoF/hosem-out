...
func create_particle():
    ...
    ps.body_set_param(water_col,Physics2DServer.BODY_PARAM_GRAVITY_SCALE,20.0)
    ...
    vs.canvas_item_set_self_modulate(water_particle,Color("b2FFFF"))
